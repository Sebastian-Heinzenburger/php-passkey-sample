async function register() {
  ...
  try {
    ...
    if (!optionsResponse.ok) {
      resultDiv.innerHTML =
        '<p class="error">' + (options.error || "Registration failed") + "</p>";
      return;
    }
    ...
    if (!verifyResponse.ok) {
      resultDiv.innerHTML =
        '<p class="error">' + (result.error || "Registration failed") + "</p>";
      return;
    }

    resultDiv.innerHTML = result.success
      ? '<p class="success">Registration successful!</p>'
      : '<p class="error">Registration failed: ' +
...
async function login() {
  ...
  try {
    ...
    if (!optionsResponse.ok) {
      resultDiv.innerHTML =
        '<p class="error">' + (options.error || "Login failed") + "</p>";
      return;
    }
    ...
    resultDiv.innerHTML = result.success
      ? '<p class="success">Login successful! Welcome, ' +
        result.username +
        "</p>"
